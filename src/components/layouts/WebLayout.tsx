  ...
  return (
    <>
      <section>
        ...
        <main
          className="relative w-full bg-cover bg-center h-[80vh] md:h-screen"
          ...
          <div className="relative z-10 container mx-auto px-6 py-4 md:py-8 text-left text-white">
            ...
            <div className="flex flex-col tracking-[.15em] items-start space-y-4 md:space-y-4">
              ...
              >
                ...
                <br />
                <span className="text-[#00B4C5] mb-[2px]">INNOVATIVE</span>{" "}
                <br />
            ...
            <div className="mt-6 max-w-3xl">
              ...
              >
                ...
                solutions that meet our client&apos;s needs and help them
                succeed. We prioritize patient-centered care to ensure the best
                possible outcome.
              </motion.p>
            </div>
          ...
          <div className="w-1/2  p-6 text-left">
            <div className="flex flex-col tracking-[.15em] items-start space-y-4 md:space-y-4">
              ...
              >
                ...
                <br />
                <span className="text-[#023550] mb-4">
            ...
            <div className="mt-6 max-w-3xl">
              ...
              >
                ...
                and time-efficient R&D services to creative minds like
                Physicians , Medical device manufactures and healthcare
                reserchers who want to realize their ingenious ideas into
                market-ready products in an accelerated process.
              </motion.p>
            </div>
