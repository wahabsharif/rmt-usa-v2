    ...
    return (
        <>
            <section>
                ...
                <main className="relative w-full bg-cover bg-center h-[80vh] md:h-screen" style={{ backgroundImage: "url('/images/hero-background.jpg')" }}>
                    ...
                    <div className="relative z-10 container mx-auto px-6 py-4 md:py-8 text-left text-white">
                        ...
                        <div className="flex flex-col tracking-[.15em] items-start space-y-4 md:space-y-4">
                            <motion.h1
                                className="text-4xl tracking-[.15em] md:text-5xl font-bold tracking-tight leading-tight"
                                initial={{ opacity: 0, y: -50 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 1 }}
                            >
                                <span className="text-white tracking-[.25em] mb-[2px] text-base md:2xl">END-TO-END SERVICE PROVIDER</span>
                                <br />
                                <span className="text-[#00B4C5] mb-[2px]">INNOVATIVE</span> <br />
                                <span className="text-white mb-[2px]">HEALTHCARE</span><br />
                    ...
                    <div className="w-1/2  p-6 text-left">
                        <div className="flex flex-col tracking-[.15em] items-start space-y-4 md:space-y-4">
                            <motion.h1
                                ...
                                transition={{ duration: 1 }}
                            >
                                <span className="text-[#023550] tracking-[.25em] mb-4 text-base md:2xl">ABOUT RMT</span>
                                <br />
                                <span className="text-[#00B4C5] mb-4">Innovating Ideas,</span> <br />
                    ...
                    <div className="w-full px-6">
                        ...
                        <div className="flex justify-center items-center flex-wrap gap-12">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center w-[18rem]">
                                ...
                                <h3 className="text-xl font-semibold text-[#02B3C6]">Product Design & Engineering</h3>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center w-[18rem]">
                                ...
                                <h3 className="text-xl font-semibold text-[#02B3C6]">Software & Artifical Intelligence</h3>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center w-[18rem]">
                                ...
                                <h3 className="text-xl font-semibold text-[#02B3C6]">Regulatory Affairs & Quality Management</h3>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center w-[18rem]">
                                ...
                                <h3 className="text-xl font-semibold text-[#02B3C6]">Quality Testing</h3>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center w-[18rem]">
                                ...
                                <h3 className="text-xl font-semibold text-[#02B3C6]">Manufacturing Consultancy</h3>
                            </div>
                        </div>
                    </div>
                </div>
